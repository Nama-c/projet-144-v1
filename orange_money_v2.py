...
historique=[]
while out == True :
    print("\n----------bienvenue sur orange money senegal !!!----------")
    ...
    print("7-Quitter")
    choix=input("\nchoisissez une option entre 1 et 7 : ")
    ...
    if choix == 1:
        ...
        # numero de telephone...
        numero=input("\nsaissisez votre numero de telephone : ")
    ...
    if choix == 2 :
        ...
        v=1
        print("\n-----voici la liste des comptes orange money-----")
        for i in tcompte :
    ...
    if choix == 3 :
        ...
        for client in tcompte :
            if client_nom == client["nom"] and client_prenom == client["prenom"]:
                ...
                compteur += 1
        if compteur == 0:
            print(f"\naucun compte trouver au nom de {client_nom} {client_prenom} !!! ")
    
    if choix == 4 :
        # 4-Recharger un compte
        compteur=0
        solde_recharge=0
        numero_client=input("\nsaisissez le numero du client a recharger : ")
        ...
        for client in tcompte:
            if numero_client == client["numero"]:
                ...
                compteur = 1
        if compteur == 0:
            print("\n aucun compte trouver a ce numero!!! ")
    ...
    if choix == 5 :
        ...
        while sorti == False :
            numero_expediteur=input("\nsaisissez le numero de l'expediteur : ")
            ...
            for client in tcompte :
                if numero_expediteur == client["numero"]:
                    ...
                    sorti=True
            if compteur == 0:
                print(f"\n--- le numero : {numero_expediteur} ne possede pas de compte ---")
                sorti=False

        asake=False
        while asake == False :
            numero_receveur=input("\nsaisissez le numero du receveur : ")
            ...
            for client in tcompte :
                if numero_receveur == client["numero"]:
                    ...
                    asake=True
            if compteur == 0:
                print(f"\n--- le numero : {numero_receveur} ne possede pas de compte ---")
                asake=False
        
        # transfert d'argent de l'expediteur vers le receveur
        montant_transfert=input("\naisissez le montant du transfert : ")
    ...
    if choix == 6 :
        ...
        print(f"\nvoici l´historique des trasnferts :\n {historique}")

    if choix == 7 :
        # 7-quitter le service orange money
        print("\n---merci d'avoir utiliser orange money et a bientot sur notre plate-forme !!!---")
        out = False